...
final class ___VARIABLE_sceneName___ViewController: UITableViewController, ___VARIABLE_sceneName___DisplayLogic {
    ...
    private func setup() {
        ...
        let interactor: __VARIABLE_sceneName___Interactor = _.init()
